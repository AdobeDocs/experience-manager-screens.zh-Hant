...
+ 製作和使用案例範例 {#authoring}
   + 設定Screens專案 {#setting-up-projects}
      ...
      + 指派管道 {#assigning-channels}
         + [頻道指派](channel-assignment-latest-fp.md)
...
+ 發行說明 {#release-notes}
   + [Feature Pack 20260318發行說明](release-notes-fp-20260318.md)
   + [Feature Pack 20251007發行說明](release-notes-fp-20251007.md)
