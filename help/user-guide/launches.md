...
例如，如果作者想要建立未來版本的c1、c2 （管道），則會建立啟動並設定上線日期（例如11月10日上午8點:00）。 內容中的任何其他更新都會寄出以供檢閱。

核准後，並在上線日期（11月10日上午8:00），此啟動會在裝置或播放器上播放內容。
...
如果上線日期是&#x200B;*11月24日，上午9:00點*，且&#x200B;*24小時*&#x200B;為寬限期，則上述動作順序會從（上線日期 — 寬限期） （亦即11月23日上午9:00點伺服器時間）開始。 此設定提供24小時完成上述所有動作，讓內容可到達播放器。 播放器瞭解此期間是啟動內容。 因此，內容不會立即播放，但播放器可將此內容儲存為未來版本，並讓內容在播放器時區的設定上線日期完全開始播放。
...
例如，如果上線日期設定為11月24日上午9:00點，而寬限期為600秒，則促銷工作會於11月24日上午8:50點開始。
