...
1. 按一下 **編輯** 從動作列移除。
1. 按一下 **設計** 模式。
1. 按一下右側的整個設計編輯器，然後按一下設定符號，您就可以開啟 **Parsys設計** 對話方塊。
1. 您可以按一下要匯入至AEM Screens專案的元件。 下列範例顯示新增的 **Livefyre** 元件至AEM Screens專案。
...
按一下轉變圖示，然後按一下 **設定** （扳手圖示）開啟 **轉變** 對話方塊。 此對話方塊包含三個索引標籤：
