...
1. **導覽至We.Retail中的網站頁面**
   ...
   1. 導覽至網站並選取 **`We.Retail`** > **美國** > **英文** > **裝置** 並選取此頁面，這樣您就可以將它當做熒幕頻道的體驗片段。

   1. 選取 **編輯** 從動作列開啟，以開啟您要用作Screens頻道體驗片段的頁面。

1. **重複使用內容**

   1. 選取您要納入頻道的片段。
   1. 從右側選取最後一個圖示，這樣您就可以開啟 **轉換為體驗片段** 對話方塊。
...
1. **建立體驗片段**
   ...
   1. 選取 **父路徑**.
   1. 選取 **範本**. 選擇 **體驗片段 — 畫面變數** 範本在此（欄位中的值） `/libs/settings/screens/experience-fragments/templates/experience-fragment-template-screens`)。

   1. 輸入 **片段標題** 作為 **ScreensFragment**.

   1. 若要完成新體驗片段的建立，請選取核取記號。

   ![screen_shot_2019-07-29at105918am](assets/screen_shot_2019-07-29at105918am.png)

   附註：若要選取較簡單的選項，請選取欄位右側的核取記號，以開啟選取對話方塊。
...
1. **建立體驗片段的即時副本**
   ...
   f.選擇 **完成** 以便移回 **ScreensFragment** 頁面。
...
1. **在畫面頻道中使用體驗片段作為元件**
   ...
   e.選取 **體驗片段** 並選取左上角（扳手）圖示，以開啟 **體驗片段** 對話方塊。
   ...
   i.選取 **離線設定** 從 **體驗片段** 對話方塊，讓您可以定義使用者端程式庫和靜態檔案。
