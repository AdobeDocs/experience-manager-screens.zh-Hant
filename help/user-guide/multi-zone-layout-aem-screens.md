...
1. 導覽至 **頻道** 資料夾並按一下 **建立** 從動作列移除。

1. 按一下 **1x2拆分畫面頻道** 從 **建立** 精靈。
...
1. **新增兩個管道至管道資料夾**
   ...
   1. 按一下 **順序頻道** 從 **建立** 精靈以建立標題為 **`Zone1`**.
   1. 按一下 **`Zone1`** 並按一下 **編輯** 從動作列移除。
   1. 拖放一些影像到此色版。
...
1. **將內嵌順序（元件）新增至主管道(MultiZone)**
   ...
   1. 按一下通道路徑作為 **區域** > **頻道** > **EmbeddedChannel** > **`Zone1`**，如下圖所示。
...
1. **建立位置**
   ...
   1. 導覽至 **區域** > **位置** 資料夾。
   1. 按一下 **位置** 資料夾並按一下 **建立** 從動作列移除。
   1. 按一下 **位置** 從 **建立** 精靈並按一下 **下一個**.
   1. 輸入 **標題** 作為 **SanJose** 並按一下 **建立**.

1. **建立顯示**

   1. 導覽至 **區域** > **位置** 資料夾。
   1. 按一下 **SanJose** 位置並按一下 **建立** 從動作列移除。
...
1. **註冊裝置**
   ...
   1. 按一下 **裝置註冊** ，然後按一下清單中的擱置裝置。

      >[!NOTE]
      > 裝置的標題必須符合裝置代號(**Token** 欄位)，顯示於 **裝置註冊** 標籤。

   1. 如果標題符合裝置Token，然後按一下裝置，再按一下 **註冊裝置** 從動作列移除。
