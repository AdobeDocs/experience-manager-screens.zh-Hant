...
1. 選取 **順序頻道** 範本來自 **建立** 精靈並選取 **下一個**.

   ![demochannel](assets/create-channel2.png)

1. 輸入標題為 **ScreensChannel** 並選取 **建立**.
...
1. 選取您要編輯的通道（如上圖所示）。
1. 選取 **編輯** 從動作列的左上角，編輯色版屬性。 編輯器會開啟，讓您新增資產/元件至您要發佈的管道。
...
1. 選取您要編輯的頻道。
1. 選取 **屬性** 以檢視/編輯頻道屬性。 下列標籤可讓您變更選項。
...
選取(**...**)從 **頻道資訊** 動作列，供您檢視屬性、編輯內容或更新頻道的快取（離線內容）。
...
1. 瀏覽至該管道做為 **測試專案** > **頻道** > **TestChannel**.
   ...
   選取 **儀表板** 以檢視播放器的狀態。 此 **頻道資訊** 面板會提供管道線上上或離線的相關資訊。

   ![screen_shot_2019-08-01at31458pm](assets/screen_shot_2019-08-01at31458pm.png)

1. 選取 **屬性** 並從動作列導覽至 **頻道** 標籤，如下所示：
...
>[!NOTE]
>若要將您的頻道再次設定為離線，請從以下位置取消勾選「開發人員模式」選項： **屬性** 標籤(如步驟(3)所示)。 然後，從 **頻道資訊** 面板選取 **更新離線內容**，如下圖所示。
