...
使用者端資料庫提供一種機制，可整理和管理AEM實作所需的CSS和JavaScript檔案。 如需使用[用戶端程式庫的更多資訊，請參閱這裡。](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/implementing/developing/introduction/clientlibs)
