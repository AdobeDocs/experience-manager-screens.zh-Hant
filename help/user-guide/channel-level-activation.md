...
1. **指派要顯示的頻道**
   ...
   1. 選擇日期 **啟用開始日期** 截至2018年11月27日晚上11:59及下午 **啟用結束日期：** 2018年11月28日半夜12點05分
   1. 選取「**儲存**」。

   >[!CAUTION]
   >
   >設定優先順序 **TargetedSinglePlay** 頻道高於 **MainAdSegment** 頻道。

   ![screen_shot_2018-11-27at31206pm](assets/screen_shot_2018-11-27at31206pm.png)

   >[!NOTE]
   >
   >若要選擇同一天，請選取隔天，然後手動將日期編輯為同一天，但稍後再編輯。 這麼做會限制使用者選取過去日期。 請參閱下列範例：
...
播放器顯示的內容 **MainAdChannel** 以及晚上11點59分（如排程所設定）， **TargetedSinglePlay** 頻道顯示其內容直到午夜12:05，然後 **MainAdChannel** 再次繼續播放其內容。
...
| 1月第一日下午2:00之後，也就是1月第二日凌晨3:00之前。 | 頻道中的資產在1月1日下午2:00之後開始播放，並持續播放1月2日的一整天，直到1月3日凌晨3:00 |
...
| **運算式** | **解譯** |
|---|---|
| 之 `February,May,August,November` | 該資產將在2月、5月、8月、11月在此頻道播放 |
...
| **運算式** | **解譯** |
|---|---|
| 6:00之後及18:00之前（星期一，1月3日星期三） | 從1月到3月底，星期一和星期三上午6點至下午6點在頻道中播放資產 |
| 1月第一日下午2:00之後，也就是1月第二日凌晨3:00之前。 | 頻道中的資產在1月1日下午2:00之後開始播放，並持續播放1月2日的一整天，直到1月3日凌晨3:00 |
| 1月1-2日下午2:00之後，以及1月2-3日凌晨3:00之前。 | 頻道中的資產在1月1日下午2:00之後開始播放程式，繼續播放至1月2日凌晨3:00，然後在1月2日下午2:00重新開始播放，並繼續播放至1月3日凌晨3:00 |
