...
1. **在位置底下建立顯示區**
   ...
   1. 瀏覽至 **頻道層級啟用** > **位置** > **地區**.
   1. 按一下 **地區** 並按一下 **+建立** 從動作列移除。
   1. 按一下 **顯示** 並從精靈中建立標題為 **區域顯示。**
...
1. **指派要顯示的頻道**
   ...
   1. **頻道指定任務** 對話方塊開啟。
   1. 按一下 **引用頻道** 依路徑。
   1. 按一下 **頻道路徑** 作為 **頻道層級啟用** > ***頻道*** > ***MainAdChannel***.
   1. 此 **頻道角色** 填入為 **mainadchannel**.
   1. 按一下 **優先順序** 作為 **1**.
   1. 按一下 **支援的事件** 作為 **初始載入** 和 **閒置畫面**.
   1. 按一下「**儲存**」。
   ...
   >[!NOTE]
   >
   >您也可以導覽至「 」，從顯示控制面板指派管道 **頻道層級啟用** > **位置** > **地區** > **區域顯示** 並選取 **儀表板** 從動作列移除。 按一下 **+指派管道** 從 **已指派的頻道與排程** 面板。
   ...
   1. **頻道指定任務** 對話方塊開啟。
   1. 按一下 **引用頻道** 依路徑。
   1. 按一下 **頻道路徑** 作為 **頻道層級啟用*** > ***頻道*** > ***TargetedSinglePlay***.
   1. 此 **頻道角色** 填入為 **targetedsingleplay**.
   1. 設定 **優先順序** 作為 **2**.
   1. 按一下 **支援的事件** 作為 **初始載入**， **閒置畫面**、和 **計時器**，如下圖所示。
