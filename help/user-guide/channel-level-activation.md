...
下圖顯示 **頻道層級啟用** 專案與 **MainAdChannel** 和 **TargetedSinglePlay** 中的管道 **頻道** 資料夾。
...
1. **指派要顯示的頻道**
   ...
   >[!NOTE]
   >
   >您也可以從顯示控制面板指派管道。 瀏覽至 **頻道層級啟用** > **位置** > **地區** > **區域顯示**. 在動作列上，選取 **儀表板**. 從 **已指派的頻道與排程** 面板，按一下 **+指派管道**.
   ...
   1. 在 **啟用開始日期**，設定為2018年11月27日晚上11:59及在 **啟用結束日期：**，設定為2018年11月28日半夜12:05
   1. 按一下「**儲存**」。

   >[!CAUTION]
   >
   >設定的優先順序 **TargetedSinglePlay** 頻道高於 **MainAdSegment** 頻道。
