...
在為AEM Screens專案設定Dispatcher之前，請先瞭解Dispatcher。如需詳細資訊，請參閱[設定Dispatcher](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-dispatcher/using/configuring/dispatcher-configuration)。
