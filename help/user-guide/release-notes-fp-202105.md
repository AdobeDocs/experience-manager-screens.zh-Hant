...
>[!IMPORTANT]
>安裝AEM 6.5 Feature Pack 8的最低版本，以便在您安裝套件`screens-cloud-ams-pkg-0.0.20`、`screens-cloud-ams-pkg-0.0.16`和`screens core bundles`後讓AMS聯結器運作。
...
根據預設，當使用大量註冊來註冊裝置時，系統產生的使用者名稱會輸入在標題欄位中。 另外，客戶可能會使用資產標籤或其他易記名稱，以便在AEM中顯示，且更易於指派適當內容。
