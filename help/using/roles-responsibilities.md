...
1. 第二階段&#x200B;*第一天*&#x200B;是指部署工作中包括的所有活動。
1. 第3個和最後一個階段&#x200B;*第2天*&#x200B;是指所有正在進行的操作和支援要素，作為整個解決方案的一部分。

>[!NOTE]
>
>雖然本指南主要強調&#x200B;*第一天*&#x200B;和&#x200B;*第二天*，但要執行一個成功的數位告示牌專案，必須注意全部三個階段。
>
>在&#x200B;**[專案管理與部署](https://helpx.adobe.com/experience-manager/6-5/screens/using/project-management-and-deployment.html)**&#x200B;上觀看其他影片，以瞭解專案預製、專案啟動和專案進展。
