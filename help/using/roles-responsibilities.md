...
>[!NOTE]
>
> 您必須擁有音訊視訊整合器，才能在AEM Screens部署中使用。
...
1. 第一個階段稱為&#x200B;*Day Zero*。 此階段包含定義專案範圍所需的所有售前和探索工作。
...
* **已通知**：隨時通知任務的進度，但不參與傳遞專案的詳細資料。

以下是使用角色定義的範例RACI圖表，並提供AEM Screens專案中常見任務和考量事項的範例。

下表摘要&#x200B;**Day Zero：售前考量事項**：

| **階段** | **音訊 — 視訊整合器** | **AEM實作人員** | **商務策略** | **內容管理** |
|---|---|---|---|---|
| 團隊組成與廠商選擇 | I | I | RA | RA |
| 角色與責任協定 | RA | RA | RA | RA |
| 與策略目標一致 | CI | I | RA | RA |
